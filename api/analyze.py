...
# Global cache for all MenuAnalyzer instances
_global_cache = {}
...
class MenuAnalyzer:
    ...
    def save_cached_result(self, cache_key: str, results: Dict[str, List[Tuple[str, int, str, str]]]):
        ...
        if self.debug:
            print(f"Cached results for {self.campus_key}")
